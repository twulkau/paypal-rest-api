...
class AuthorizationApi
{
    ...
    {
        $this->generateAccessTokenWithHttpInfo();
    }
     ...
     */
    public function generateAccessTokenWithHttpInfo()
    {
        $returnType = '';
     ...
     */
    public function generateAccessTokenAsync()
    {
        return $this->generateAccessTokenAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateAccessTokenAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->generateAccessTokenRequest();
     ...
     */
    protected function generateAccessTokenRequest()
    {
    ...
    {
        $this->generateClientTokenWithHttpInfo();
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function generateClientTokenWithHttpInfo()
    {
        $returnType = '';
        $request = $this->generateClientTokenRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateClientTokenAsync()
    {
        return $this->generateClientTokenAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function generateClientTokenAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->generateClientTokenRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function generateClientTokenRequest()
    {
    ...
    {
        $this->terminateAccessTokenWithHttpInfo();
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function terminateAccessTokenWithHttpInfo()
    {
        $returnType = '';
        $request = $this->terminateAccessTokenRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function terminateAccessTokenAsync()
    {
        return $this->terminateAccessTokenAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function terminateAccessTokenAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->terminateAccessTokenRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function terminateAccessTokenRequest()
    {
     ...
     * User Info
     *
     * @param  object $schema (Required) Filters the response by a schema. Supported value is &#x60;paypalv1.1&#x60;. (optional)
    ...
    {
        $this->userInfoWithHttpInfo($schema, $pay_pal_request_id, $pay_pal_client_metadata_id, $pay_pal_partner_attribution_id, $pay_pal_auth_assertion, $prefer, $prefer2);
    }
