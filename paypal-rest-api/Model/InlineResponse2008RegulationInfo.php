<?php
/**
 * InlineResponse2008RegulationInfo
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * InlineResponse2008RegulationInfo Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2008RegulationInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_8_regulation_info';
    ...
    protected static $attributeMap = [
        'regulation_covered' => 'regulation_covered'
    ];
    ...
    protected static $setters = [
        'regulation_covered' => 'setRegulationCovered'
    ];
    ...
    protected static $getters = [
        'regulation_covered' => 'getRegulationCovered'
    ];
    ...
    {
        $this->container['regulation_covered'] = isset($data['regulation_covered']) ? $data['regulation_covered'] : null;
    }
    ...
    /**
     * Gets regulation_covered
     *
     * @return string
     */
    public function getRegulationCovered()
    {
        return $this->container['regulation_covered'];
    }

    /**
     * Sets regulation_covered
     *
     * @param string $regulation_covered regulation_covered
     *
     * @return $this
     */
    public function setRegulationCovered($regulation_covered)
    {
        $this->container['regulation_covered'] = $regulation_covered;
