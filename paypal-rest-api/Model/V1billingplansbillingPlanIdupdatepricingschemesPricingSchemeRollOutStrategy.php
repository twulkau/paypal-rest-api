<?php
/**
 * V1billingplansbillingPlanIdupdatepricingschemesPricingSchemeRollOutStrategy
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V1billingplansbillingPlanIdupdatepricingschemesPricingSchemeRollOutStrategy Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1billingplansbillingPlanIdupdatepricingschemesPricingSchemeRollOutStrategy implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1billingplansbilling_plan_idupdatepricingschemes_pricing_scheme_roll_out_strategy';
    ...
    protected static $attributeMap = [
        ...
        'process_change_from' => 'process_change_from'
    ];
    ...
    protected static $setters = [
        ...
        'process_change_from' => 'setProcessChangeFrom'
    ];
    ...
    protected static $getters = [
        ...
        'process_change_from' => 'getProcessChangeFrom'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['process_change_from'] = isset($data['process_change_from']) ? $data['process_change_from'] : null;
    }
    ...
    /**
     * Gets process_change_from
     *
     * @return string
     */
    public function getProcessChangeFrom()
    {
        return $this->container['process_change_from'];
    }

    /**
     * Sets process_change_from
     *
     * @param string $process_change_from process_change_from
     *
     * @return $this
     */
    public function setProcessChangeFrom($process_change_from)
    {
        $this->container['process_change_from'] = $process_change_from;
