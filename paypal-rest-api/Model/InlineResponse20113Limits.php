...
/**
 * InlineResponse20113Limits Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20113Limits implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_13_limits';
    ...
    protected static $setters = [
        'remaining_value' => 'setRemainingValue',
        'type' => 'setType',
        'unit' => 'setUnit',
        'value' => 'setValue'
    ];
    ...
    protected static $getters = [
        'remaining_value' => 'getRemainingValue',
        'type' => 'getType',
        'unit' => 'getUnit',
        'value' => 'getValue'
    ];
    ...
    {
        $this->container['remaining_value'] = isset($data['remaining_value']) ? $data['remaining_value'] : null;
    ...
    /**
     * Gets remaining_value
     *
     * @return string
     */
    public function getRemainingValue()
    {
        return $this->container['remaining_value'];
    }

    /**
     * Sets remaining_value
     *
     * @param string $remaining_value remaining_value
     *
     * @return $this
     */
    public function setRemainingValue($remaining_value)
    {
        $this->container['remaining_value'] = $remaining_value;
