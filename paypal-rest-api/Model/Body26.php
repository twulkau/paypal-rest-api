...
class Body26 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'op' => 'string',
        'path' => 'string',
        'value' => '\PayPal\RestApi\Model\V1notificationswebhookswebhookIdValue[]'
    ];
     ...
     * Gets value
     *
     * @return \PayPal\RestApi\Model\V1notificationswebhookswebhookIdValue[]
     */
     ...
     * Sets value
     *
     * @param \PayPal\RestApi\Model\V1notificationswebhookswebhookIdValue[] $value value
     *
     * @return $this
     */
