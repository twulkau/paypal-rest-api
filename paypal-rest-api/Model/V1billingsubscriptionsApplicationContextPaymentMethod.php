<?php
/**
 * V1billingsubscriptionsApplicationContextPaymentMethod
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V1billingsubscriptionsApplicationContextPaymentMethod Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1billingsubscriptionsApplicationContextPaymentMethod implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1billingsubscriptions_application_context_payment_method';
    ...
    protected static $setters = [
        ...
        'payer_selected' => 'setPayerSelected'
    ];
    ...
    protected static $getters = [
        ...
        'payer_selected' => 'getPayerSelected'
    ];
    ...
    {
        $this->container['payee_preferred'] = isset($data['payee_preferred']) ? $data['payee_preferred'] : null;
        $this->container['payer_selected'] = isset($data['payer_selected']) ? $data['payer_selected'] : null;
    }
     ...
     *
     * @param string $payee_preferred payee_preferred
     *
     * @return $this
     */
    ...
    {
        return $this->container['payer_selected'];
    }

    /**
     * Sets payer_selected
     *
     * @param string $payer_selected payer_selected
     *
     * @return $this
     */
    public function setPayerSelected($payer_selected)
    {
        $this->container['payer_selected'] = $payer_selected;
