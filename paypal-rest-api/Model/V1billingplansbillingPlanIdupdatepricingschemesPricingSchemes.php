<?php
/**
 * V1billingplansbillingPlanIdupdatepricingschemesPricingSchemes
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V1billingplansbillingPlanIdupdatepricingschemesPricingSchemes Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V1billingplansbillingPlanIdupdatepricingschemesPricingSchemes implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v1billingplansbilling_plan_idupdatepricingschemes_pricing_schemes';
    ...
    protected static $swaggerTypes = [
        'billing_cycle_sequence' => 'float',
        'pricing_scheme' => '\PayPal\RestApi\Model\V1billingplansbillingPlanIdupdatepricingschemesPricingScheme'
    ];
    ...
    protected static $setters = [
        'billing_cycle_sequence' => 'setBillingCycleSequence',
    ...
    protected static $getters = [
        'billing_cycle_sequence' => 'getBillingCycleSequence',
    ...
    {
        $this->container['billing_cycle_sequence'] = isset($data['billing_cycle_sequence']) ? $data['billing_cycle_sequence'] : null;
    ...
    /**
     * Gets billing_cycle_sequence
     *
     * @return float
     */
    public function getBillingCycleSequence()
    {
        return $this->container['billing_cycle_sequence'];
    }

    /**
     * Sets billing_cycle_sequence
     *
     * @param float $billing_cycle_sequence billing_cycle_sequence
     *
     * @return $this
     */
    public function setBillingCycleSequence($billing_cycle_sequence)
    {
        $this->container['billing_cycle_sequence'] = $billing_cycle_sequence;
     ...
     * Gets pricing_scheme
     *
     * @return \PayPal\RestApi\Model\V1billingplansbillingPlanIdupdatepricingschemesPricingScheme
     */
     ...
     * Sets pricing_scheme
     *
     * @param \PayPal\RestApi\Model\V1billingplansbillingPlanIdupdatepricingschemesPricingScheme $pricing_scheme pricing_scheme
     *
     * @return $this
     */
