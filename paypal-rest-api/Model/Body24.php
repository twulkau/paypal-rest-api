...
class Body24 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'event_types' => '\PayPal\RestApi\Model\V1notificationswebhooksEventTypes[]',
        'url' => 'string'
    ];
     ...
     * Gets event_types
     *
     * @return \PayPal\RestApi\Model\V1notificationswebhooksEventTypes[]
     */
     ...
     * Sets event_types
     *
     * @param \PayPal\RestApi\Model\V1notificationswebhooksEventTypes[] $event_types event_types
     *
     * @return $this
     */
