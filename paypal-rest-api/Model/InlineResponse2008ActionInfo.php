...
/**
 * InlineResponse2008ActionInfo Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2008ActionInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_8_action_info';
    ...
    protected static $setters = [
        'action' => 'setAction',
        'response_option' => 'setResponseOption'
    ];
    ...
    protected static $getters = [
        'action' => 'getAction',
        'response_option' => 'getResponseOption'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['response_option'] = isset($data['response_option']) ? $data['response_option'] : null;
    }
    ...
    /**
     * Gets response_option
     *
     * @return string
     */
    public function getResponseOption()
    {
        return $this->container['response_option'];
    }

    /**
     * Sets response_option
     *
     * @param string $response_option response_option
     *
     * @return $this
     */
    public function setResponseOption($response_option)
    {
        $this->container['response_option'] = $response_option;
