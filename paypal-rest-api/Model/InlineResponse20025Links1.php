...
/**
 * InlineResponse20025Links1 Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20025Links1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_25_links_1';
    ...
    {
        $this->container['enc_type'] = isset($data['enc_type']) ? $data['enc_type'] : null;
    ...
    {
        return $this->container['enc_type'];
    }

    /**
     * Sets enc_type
     *
     * @param string $enc_type enc_type
     *
     * @return $this
     */
    public function setEncType($enc_type)
    {
        $this->container['enc_type'] = $enc_type;
