<?php
/**
 * InlineResponse20033Configuration
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * InlineResponse20033Configuration Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20033Configuration implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_33_configuration';
    ...
    protected static $swaggerTypes = [
        'allow_tip' => 'bool',
        'partial_payment' => '\PayPal\RestApi\Model\V2invoicinginvoicesConfigurationPartialPayment',
    ...
    protected static $swaggerFormats = [
        ...
        'tax_calculated_after_discount' => null,
        'tax_inclusive' => null,
        'template_id' => null
    ];
    ...
    protected static $setters = [
        'allow_tip' => 'setAllowTip',
        'partial_payment' => 'setPartialPayment',
        'tax_calculated_after_discount' => 'setTaxCalculatedAfterDiscount',
    ...
    protected static $getters = [
        'allow_tip' => 'getAllowTip',
        'partial_payment' => 'getPartialPayment',
        'tax_calculated_after_discount' => 'getTaxCalculatedAfterDiscount',
    ...
    {
        $this->container['allow_tip'] = isset($data['allow_tip']) ? $data['allow_tip'] : null;
        $this->container['partial_payment'] = isset($data['partial_payment']) ? $data['partial_payment'] : null;
        $this->container['tax_calculated_after_discount'] = isset($data['tax_calculated_after_discount']) ? $data['tax_calculated_after_discount'] : null;
    ...
    {
        return $this->container['allow_tip'];
    }

    /**
     * Sets allow_tip
     *
     * @param bool $allow_tip allow_tip
     *
     * @return $this
     */
    public function setAllowTip($allow_tip)
    {
        $this->container['allow_tip'] = $allow_tip;
     ...
     *
     * @return \PayPal\RestApi\Model\V2invoicinginvoicesConfigurationPartialPayment
     */
     ...
     *
     * @param \PayPal\RestApi\Model\V2invoicinginvoicesConfigurationPartialPayment $partial_payment partial_payment
     *
     * @return $this
     */
    ...
    /**
     * Gets tax_calculated_after_discount
     *
     * @return bool
     */
    public function getTaxCalculatedAfterDiscount()
    {
        return $this->container['tax_calculated_after_discount'];
    }

    /**
     * Sets tax_calculated_after_discount
     *
     * @param bool $tax_calculated_after_discount tax_calculated_after_discount
     *
     * @return $this
     */
    public function setTaxCalculatedAfterDiscount($tax_calculated_after_discount)
    {
        $this->container['tax_calculated_after_discount'] = $tax_calculated_after_discount;
     ...
     * Sets tax_inclusive
     *
     * @param bool $tax_inclusive tax_inclusive
     *
     * @return $this
     */
