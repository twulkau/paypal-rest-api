...
class InlineResponse2012 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'create_time' => 'string',
        'id' => 'string',
        'links' => '\PayPal\RestApi\Model\InlineResponse2012Links[]',
        'name' => 'string'
    ];
     ...
     * Gets links
     *
     * @return \PayPal\RestApi\Model\InlineResponse2012Links[]
     */
     ...
     * Sets links
     *
     * @param \PayPal\RestApi\Model\InlineResponse2012Links[] $links links
     *
     * @return $this
     */
