<?php
/**
 * V2invoicingtemplatesSettingsTemplateSubtotalSettings
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V2invoicingtemplatesSettingsTemplateSubtotalSettings Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V2invoicingtemplatesSettingsTemplateSubtotalSettings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2invoicingtemplates_settings_template_subtotal_settings';
    ...
    protected static $swaggerTypes = [
        'display_preference' => '\PayPal\RestApi\Model\V2invoicingtemplatesSettingsDisplayPreference',
        'field_name' => 'string'
    ];
     ...
     *
     * @return \PayPal\RestApi\Model\V2invoicingtemplatesSettingsDisplayPreference
     */
     ...
     *
     * @param \PayPal\RestApi\Model\V2invoicingtemplatesSettingsDisplayPreference $display_preference display_preference
     *
     * @return $this
     */
