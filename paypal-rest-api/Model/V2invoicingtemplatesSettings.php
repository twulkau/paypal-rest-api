...
/**
 * V2invoicingtemplatesSettings Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V2invoicingtemplatesSettings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2invoicingtemplates_settings';
    ...
    protected static $swaggerTypes = [
        'template_item_settings' => '\PayPal\RestApi\Model\InlineResponse20038SettingsTemplateItemSettings[]',
        'template_subtotal_settings' => '\PayPal\RestApi\Model\V2invoicingtemplatesSettingsTemplateSubtotalSettings[]'
    ];
    ...
    protected static $swaggerFormats = [
        'template_item_settings' => null,
        'template_subtotal_settings' => null
    ];
    ...
    protected static $setters = [
        'template_item_settings' => 'setTemplateItemSettings',
        'template_subtotal_settings' => 'setTemplateSubtotalSettings'
    ];
    ...
    protected static $getters = [
        'template_item_settings' => 'getTemplateItemSettings',
        'template_subtotal_settings' => 'getTemplateSubtotalSettings'
    ];
    ...
    {
        $this->container['template_item_settings'] = isset($data['template_item_settings']) ? $data['template_item_settings'] : null;
        $this->container['template_subtotal_settings'] = isset($data['template_subtotal_settings']) ? $data['template_subtotal_settings'] : null;
    }
    ...
    /**
     * Gets template_item_settings
     *
     * @return \PayPal\RestApi\Model\InlineResponse20038SettingsTemplateItemSettings[]
     */
    public function getTemplateItemSettings()
    {
        return $this->container['template_item_settings'];
    }

    /**
     * Sets template_item_settings
     *
     * @param \PayPal\RestApi\Model\InlineResponse20038SettingsTemplateItemSettings[] $template_item_settings template_item_settings
     *
     * @return $this
     */
    public function setTemplateItemSettings($template_item_settings)
    {
        $this->container['template_item_settings'] = $template_item_settings;

        return $this;
    }

    /**
     * Gets template_subtotal_settings
     *
     * @return \PayPal\RestApi\Model\V2invoicingtemplatesSettingsTemplateSubtotalSettings[]
     */
    public function getTemplateSubtotalSettings()
    {
        return $this->container['template_subtotal_settings'];
    }

    /**
     * Sets template_subtotal_settings
     *
     * @param \PayPal\RestApi\Model\V2invoicingtemplatesSettingsTemplateSubtotalSettings[] $template_subtotal_settings template_subtotal_settings
     *
     * @return $this
     */
    public function setTemplateSubtotalSettings($template_subtotal_settings)
    {
        $this->container['template_subtotal_settings'] = $template_subtotal_settings;
