<?php
/**
 * V2invoicinginvoicesinvoiceIdDetail
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V2invoicinginvoicesinvoiceIdDetail Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V2invoicinginvoicesinvoiceIdDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2invoicinginvoicesinvoice_id_detail';
    ...
    protected static $swaggerTypes = [
        ...
        'memo' => 'string',
        'note' => 'string',
        'payment_term' => '\PayPal\RestApi\Model\V2invoicinginvoicesinvoiceIdDetailPaymentTerm',
        'reference' => 'string',
        'term' => 'string'
    ];
     ...
     * Gets payment_term
     *
     * @return \PayPal\RestApi\Model\V2invoicinginvoicesinvoiceIdDetailPaymentTerm
     */
     ...
     * Sets payment_term
     *
     * @param \PayPal\RestApi\Model\V2invoicinginvoicesinvoiceIdDetailPaymentTerm $payment_term payment_term
     *
     * @return $this
     */
