...
/**
 * V2invoicinginvoicesDiscount Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V2invoicinginvoicesDiscount implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2invoicinginvoices_discount';
    ...
    protected static $swaggerTypes = [
        'amount' => '\PayPal\RestApi\Model\V2invoicinginvoicesDiscountAmount',
        'percent' => 'string'
    ];
     ...
     * Sets amount
     *
     * @param \PayPal\RestApi\Model\V2invoicinginvoicesDiscountAmount $amount amount
     *
     * @return $this
     */
