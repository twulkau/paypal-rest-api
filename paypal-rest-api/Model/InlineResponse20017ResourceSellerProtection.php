<?php
/**
 * InlineResponse20017ResourceSellerProtection
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * InlineResponse20017ResourceSellerProtection Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20017ResourceSellerProtection implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_17_resource_seller_protection';
    ...
    protected static $setters = [
        'dispute_categories' => 'setDisputeCategories',
        'status' => 'setStatus'
    ];
    ...
    protected static $getters = [
        'dispute_categories' => 'getDisputeCategories',
        'status' => 'getStatus'
    ];
    ...
    {
        $this->container['dispute_categories'] = isset($data['dispute_categories']) ? $data['dispute_categories'] : null;
    ...
    {
        return $this->container['dispute_categories'];
    }

    /**
     * Sets dispute_categories
     *
     * @param string[] $dispute_categories dispute_categories
     *
     * @return $this
     */
    public function setDisputeCategories($dispute_categories)
    {
        $this->container['dispute_categories'] = $dispute_categories;
