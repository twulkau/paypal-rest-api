...
class Body47 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'op' => 'string',
        'path' => 'string',
        'value' => '\PayPal\RestApi\Model\V3customermanagedaccountsidValue[]'
    ];
     ...
     * Gets value
     *
     * @return \PayPal\RestApi\Model\V3customermanagedaccountsidValue[]
     */
     ...
     * Sets value
     *
     * @param \PayPal\RestApi\Model\V3customermanagedaccountsidValue[] $value value
     *
     * @return $this
     */
