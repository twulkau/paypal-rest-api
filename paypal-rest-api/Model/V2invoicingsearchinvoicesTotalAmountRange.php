<?php
/**
 * V2invoicingsearchinvoicesTotalAmountRange
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V2invoicingsearchinvoicesTotalAmountRange Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V2invoicingsearchinvoicesTotalAmountRange implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2invoicingsearchinvoices_total_amount_range';
    ...
    protected static $swaggerTypes = [
        'lower_amount' => '\PayPal\RestApi\Model\InlineResponse2007DisputeAmount',
        'upper_amount' => '\PayPal\RestApi\Model\InlineResponse20030Amount'
    ];
    ...
    protected static $setters = [
        'lower_amount' => 'setLowerAmount',
        'upper_amount' => 'setUpperAmount'
    ];
    ...
    protected static $getters = [
        'lower_amount' => 'getLowerAmount',
        'upper_amount' => 'getUpperAmount'
    ];
    ...
    {
        $this->container['lower_amount'] = isset($data['lower_amount']) ? $data['lower_amount'] : null;
        $this->container['upper_amount'] = isset($data['upper_amount']) ? $data['upper_amount'] : null;
    }
    ...
    {
        return $this->container['lower_amount'];
    }

    /**
     * Sets lower_amount
     *
     * @param \PayPal\RestApi\Model\InlineResponse2007DisputeAmount $lower_amount lower_amount
     *
     * @return $this
     */
    public function setLowerAmount($lower_amount)
    {
        $this->container['lower_amount'] = $lower_amount;
     ...
     * Gets upper_amount
     *
     * @return \PayPal\RestApi\Model\InlineResponse20030Amount
     */
    public function getUpperAmount()
    {
        return $this->container['upper_amount'];
    }

    /**
     * Sets upper_amount
     *
     * @param \PayPal\RestApi\Model\InlineResponse20030Amount $upper_amount upper_amount
     *
     * @return $this
     */
    public function setUpperAmount($upper_amount)
    {
        $this->container['upper_amount'] = $upper_amount;
