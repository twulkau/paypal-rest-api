<?php
/**
 * V2invoicinginvoicesConfigurationPartialPayment
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V2invoicinginvoicesConfigurationPartialPayment Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V2invoicinginvoicesConfigurationPartialPayment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2invoicinginvoices_configuration_partial_payment';
    ...
    protected static $swaggerTypes = [
        ...
        'minimum_amount_due' => '\PayPal\RestApi\Model\V2invoicinginvoicesConfigurationPartialPaymentMinimumAmountDue'
    ];
    ...
    {
        $this->container['allow_partial_payment'] = isset($data['allow_partial_payment']) ? $data['allow_partial_payment'] : null;
        $this->container['minimum_amount_due'] = isset($data['minimum_amount_due']) ? $data['minimum_amount_due'] : null;
    }
     ...
     *
     * @param bool $allow_partial_payment allow_partial_payment
     *
     * @return $this
     */
     ...
     *
     * @return \PayPal\RestApi\Model\V2invoicinginvoicesConfigurationPartialPaymentMinimumAmountDue
     */
     ...
     *
     * @param \PayPal\RestApi\Model\V2invoicinginvoicesConfigurationPartialPaymentMinimumAmountDue $minimum_amount_due minimum_amount_due
     *
     * @return $this
     */
