...
class InlineResponse2006 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'id' => 'string',
        'image_url' => 'string',
        'links' => '\PayPal\RestApi\Model\InlineResponse2006Links[]',
        'name' => 'string',
        'type' => 'string',
        'update_time' => 'string'
    ];
     ...
     * Gets links
     *
     * @return \PayPal\RestApi\Model\InlineResponse2006Links[]
     */
     ...
     * Sets links
     *
     * @param \PayPal\RestApi\Model\InlineResponse2006Links[] $links links
     *
     * @return $this
     */
