<?php
/**
 * V3customermanagedaccountsBusinessEntityBeneficialOwnersIndividuals
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V3customermanagedaccountsBusinessEntityBeneficialOwnersIndividuals Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class V3customermanagedaccountsBusinessEntityBeneficialOwnersIndividuals implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v3customermanagedaccounts_business_entity_beneficial_owners_individuals';
    ...
    protected static $swaggerTypes = [
        'addresses' => '\PayPal\RestApi\Model\V3customermanagedaccountsBusinessEntityBeneficialOwnersAddresses[]',
        'birth_details' => '\PayPal\RestApi\Model\V3customermanagedaccountsBusinessEntityBeneficialOwnersBirthDetails',
        'citizenship' => 'string',
        'controlling_influence' => 'bool',
        'identification_documents' => '\PayPal\RestApi\Model\V3customermanagedaccountsBusinessEntityBeneficialOwnersIdentificationDocuments[]',
        'names' => '\PayPal\RestApi\Model\V3customermanagedaccountsBusinessEntityBeneficialOwnersNames[]',
    ...
    protected static $attributeMap = [
        ...
        'controlling_influence' => 'controlling_influence',
    ...
    protected static $setters = [
        ...
        'birth_details' => 'setBirthDetails',
        'citizenship' => 'setCitizenship',
        'controlling_influence' => 'setControllingInfluence',
        'identification_documents' => 'setIdentificationDocuments',
        'names' => 'setNames',
        'percentage_of_ownership' => 'setPercentageOfOwnership'
    ];
    ...
    protected static $getters = [
        ...
        'birth_details' => 'getBirthDetails',
        'citizenship' => 'getCitizenship',
        'controlling_influence' => 'getControllingInfluence',
        'identification_documents' => 'getIdentificationDocuments',
        'names' => 'getNames',
        'percentage_of_ownership' => 'getPercentageOfOwnership'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['birth_details'] = isset($data['birth_details']) ? $data['birth_details'] : null;
        $this->container['citizenship'] = isset($data['citizenship']) ? $data['citizenship'] : null;
        $this->container['controlling_influence'] = isset($data['controlling_influence']) ? $data['controlling_influence'] : null;
        ...
        $this->container['percentage_of_ownership'] = isset($data['percentage_of_ownership']) ? $data['percentage_of_ownership'] : null;
    }
     ...
     * Gets addresses
     *
     * @return \PayPal\RestApi\Model\V3customermanagedaccountsBusinessEntityBeneficialOwnersAddresses[]
     */
     ...
     * Sets addresses
     *
     * @param \PayPal\RestApi\Model\V3customermanagedaccountsBusinessEntityBeneficialOwnersAddresses[] $addresses addresses
     *
     * @return $this
     */
     ...
     * Gets birth_details
     *
     * @return \PayPal\RestApi\Model\V3customermanagedaccountsBusinessEntityBeneficialOwnersBirthDetails
     */
    public function getBirthDetails()
    {
        return $this->container['birth_details'];
    }

    /**
     * Sets birth_details
     *
     * @param \PayPal\RestApi\Model\V3customermanagedaccountsBusinessEntityBeneficialOwnersBirthDetails $birth_details birth_details
     *
     * @return $this
     */
    public function setBirthDetails($birth_details)
    {
        $this->container['birth_details'] = $birth_details;
    ...
    /**
     * Gets controlling_influence
     *
     * @return bool
     */
    public function getControllingInfluence()
    {
        return $this->container['controlling_influence'];
    }

    /**
     * Sets controlling_influence
     *
     * @param bool $controlling_influence controlling_influence
     *
     * @return $this
     */
    public function setControllingInfluence($controlling_influence)
    {
        $this->container['controlling_influence'] = $controlling_influence;
     ...
     *
     * @return \PayPal\RestApi\Model\V3customermanagedaccountsBusinessEntityBeneficialOwnersIdentificationDocuments[]
     */
     ...
     *
     * @param \PayPal\RestApi\Model\V3customermanagedaccountsBusinessEntityBeneficialOwnersIdentificationDocuments[] $identification_documents identification_documents
     *
     * @return $this
     */
     ...
     * Gets names
     *
     * @return \PayPal\RestApi\Model\V3customermanagedaccountsBusinessEntityBeneficialOwnersNames[]
     */
     ...
     * Sets names
     *
     * @param \PayPal\RestApi\Model\V3customermanagedaccountsBusinessEntityBeneficialOwnersNames[] $names names
     *
     * @return $this
     */
    ...
    /**
     * Gets percentage_of_ownership
     *
     * @return string
     */
    public function getPercentageOfOwnership()
    {
        return $this->container['percentage_of_ownership'];
    }

    /**
     * Sets percentage_of_ownership
     *
     * @param string $percentage_of_ownership percentage_of_ownership
     *
     * @return $this
     */
    public function setPercentageOfOwnership($percentage_of_ownership)
    {
        $this->container['percentage_of_ownership'] = $percentage_of_ownership;
