...
class Body34 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerFormats = [
        ...
        'note' => null,
        'send_to_invoicer' => null,
        'send_to_recipient' => null,
        'subject' => null
    ];
    ...
    protected static $setters = [
        ...
        'note' => 'setNote',
        'send_to_invoicer' => 'setSendToInvoicer',
        'send_to_recipient' => 'setSendToRecipient',
        'subject' => 'setSubject'
    ];
    ...
    protected static $getters = [
        ...
        'note' => 'getNote',
        'send_to_invoicer' => 'getSendToInvoicer',
        'send_to_recipient' => 'getSendToRecipient',
        'subject' => 'getSubject'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['send_to_invoicer'] = isset($data['send_to_invoicer']) ? $data['send_to_invoicer'] : null;
        $this->container['send_to_recipient'] = isset($data['send_to_recipient']) ? $data['send_to_recipient'] : null;
    ...
    /**
     * Gets send_to_invoicer
     *
     * @return bool
     */
    public function getSendToInvoicer()
    {
        return $this->container['send_to_invoicer'];
    }

    /**
     * Sets send_to_invoicer
     *
     * @param bool $send_to_invoicer send_to_invoicer
     *
     * @return $this
     */
    public function setSendToInvoicer($send_to_invoicer)
    {
        $this->container['send_to_invoicer'] = $send_to_invoicer;

        return $this;
    }

    /**
     * Gets send_to_recipient
     *
     * @return bool
     */
    public function getSendToRecipient()
    {
        return $this->container['send_to_recipient'];
    }

    /**
     * Sets send_to_recipient
     *
     * @param bool $send_to_recipient send_to_recipient
     *
     * @return $this
     */
    public function setSendToRecipient($send_to_recipient)
    {
        $this->container['send_to_recipient'] = $send_to_recipient;
