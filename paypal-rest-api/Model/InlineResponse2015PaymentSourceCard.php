<?php
/**
 * InlineResponse2015PaymentSourceCard
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * InlineResponse2015PaymentSourceCard Class Doc Comment
 *
 * @category Class
 * @package  PayPal\RestApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2015PaymentSourceCard implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_5_payment_source_card';
    ...
    {
        $this->container['available_networks'] = isset($data['available_networks']) ? $data['available_networks'] : null;
        $this->container['bin_details'] = isset($data['bin_details']) ? $data['bin_details'] : null;
        $this->container['brand'] = isset($data['brand']) ? $data['brand'] : null;
        $this->container['expiry'] = isset($data['expiry']) ? $data['expiry'] : null;
        $this->container['last_digits'] = isset($data['last_digits']) ? $data['last_digits'] : null;
     ...
     *
     * @param string[] $available_networks available_networks
     *
     * @return $this
     */
     ...
     * Sets bin_details
     *
     * @param object $bin_details bin_details
     *
     * @return $this
     */
