...
class Body implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'billing_cycles' => '\PayPal\RestApi\Model\V1billingplansBillingCycles[]',
        'description' => 'string',
        'name' => 'string',
        'payment_preferences' => '\PayPal\RestApi\Model\V1billingplansPaymentPreferences',
        'product_id' => 'string',
        'status' => 'string',
        'taxes' => '\PayPal\RestApi\Model\V1billingplansTaxes'
    ];
     ...
     * Gets billing_cycles
     *
     * @return \PayPal\RestApi\Model\V1billingplansBillingCycles[]
     */
     ...
     * Sets billing_cycles
     *
     * @param \PayPal\RestApi\Model\V1billingplansBillingCycles[] $billing_cycles billing_cycles
     *
     * @return $this
     */
     ...
     *
     * @return \PayPal\RestApi\Model\V1billingplansPaymentPreferences
     */
     ...
     *
     * @param \PayPal\RestApi\Model\V1billingplansPaymentPreferences $payment_preferences payment_preferences
     *
     * @return $this
     */
     ...
     * Gets taxes
     *
     * @return \PayPal\RestApi\Model\V1billingplansTaxes
     */
     ...
     * Sets taxes
     *
     * @param \PayPal\RestApi\Model\V1billingplansTaxes $taxes taxes
     *
     * @return $this
     */
